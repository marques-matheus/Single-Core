...
const About = () => {
    ...
    return (
        <section className="flex flex-col lg:flex-row items-center space-x-5 justify-around about px-10 py-16 h-fit bg-white">
            <article className="lg::w-1/2 lg:max-w-lg p-5 border-b-2 border-sc-600 lg:border-b-0 mb-10 lg:mb-0">
