...
const Footer = () => {
    return (
        <footer>
            <Banner d='flex-col'>
                <section className="flex items-center justify-evenly w-5/6 m-auto py-10 border-b-2 border-sc-600 ">
                ...
                <section className="flex items-center justify-evenly w-5/6 h-96 m-auto py-10 ">
                    <article className='flex flex-col items-start justify-around max-w-xs space-y-3'>
                        <Image src="/logo1.png" width={180} height={80} alt="logo" />
                        <p className='text-sc-700'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem, vero.</p>
                    ...
                    <article className='bg-sc-800 w-32 '>.</article>
                    <article className='bg-sc-800 w-32 '>.</article>
                    <article className='bg-sc-800 w-32 '>.</article>
                </section>

                <div className='self-center items-center p-3'> <h6>&copy; {new Date().getFullYear()} Todos os direitos reservados - Single Core </h6>  </div>
            </Banner>
        </footer>
    )
