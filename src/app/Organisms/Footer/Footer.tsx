...
const Footer = ({ openModal, setOpenModal }: { openModal: boolean, setOpenModal: any }) => {
    return (
        <footer className='flex flex-col w-full h-hit bg-gradient-to-t from-sc-700 to-sc-800 ' id='footer'>
            ...
            <section className="hidden lg:flex items-center justify-between w-5/6 m-auto py-10 border-b-2 border-sc-600 lg:max-w-6xl">
                {/* <article className='flex flex-row p-2 space-x-2 font-bold text-white items-center'>
                    <Phone size={35} />
                    <h3>(21) 98360-3454</h3>
                </article> */}
                <a href="mailto:faleconosco@singlecore.com.br" className='flex flex-row p-2 space-x-2 font-bold text-white items-center'>
                    <Mail size={35} />
